...
for slices in range(300,3600):
	...
	x2Com = 0
	xyCom = 0
	eArray = scipy.zeros((800, 800), float) 
	#im = Image.open("/Users/mdgreenb/Dropbox/In Progress/T82/T82_Stats_%04i.png" % slices)
	im = Image.open("E:\Users\Stardust\Desktop\zSlices\T128b\T128b_zSlices_%04i.png" % slices)
	pix = im.load()
