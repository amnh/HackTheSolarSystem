...
#for slices in range(2500,2503):
	...
	im = Image.open("/Users/mdgreenb/Desktop/T163/T163_Stats_%04i.png" % slices)
	#im = Image.open("c:/Documents and Settings/Users/debel/My Documents/Dropbox/In Progress/T128a/T128a_Stats_%04i.png" % slices)
