...
s = 100
pi = 3.1415926
file = open("E:Users\Stardust\Dropbox\In Progress\P3\Data\T128a_Stats_New.txt" , 'w')	
file.write('slices, area, volume, radius, xCom, yCom, semimajor, semiminor \n')
file.close
for slices in range(500,7690):
#for slices in range(2500,2503):
	...
	x2Com = 0
	xyCom = 0
	eArray = scipy.zeros((1350, 1350), float) 
	#im = Image.open("/Users/mdgreenb/Dropbox/In Progress/T82/T82_Stats_%04i.png" % slices)
	im = Image.open("E:\Users\Stardust\Desktop\zSlices\T128a\T128a_zSlices_%04i.png" % slices)
