...
#for slices in range(2500,2503):
	...
	x2Com = 0
	xyCom = 0
	eArray = scipy.zeros((1500, 1500), float) 
	im = Image.open("/Users/mdgreenb/Dropbox/In Progress/T128b/T128b_Stats_%04i.png" % slices)
	#im = Image.open("c:/Documents and Settings/Users/debel/My Documents/Dropbox/In Progress/T128b/T128b_Stats_%04i.png" % slices)
