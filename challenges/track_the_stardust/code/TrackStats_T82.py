...
#for slices in range(2500,2503):
	...
	x2Com = 0
	xyCom = 0
	eArray = scipy.zeros((500, 500), float) 
	#im = Image.open("/Users/mdgreenb/Dropbox/In Progress/T82/T82_Stats_%04i.png" % slices)
	im = Image.open("E:\Users\Stardust\Desktop\T82_zSlices\T82_sliced_%04i.png" % slices)
